    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <Card title="AI search">
          <p className="mb-4 text-sm text-slate-600">Find vendors, resellers, and use-case matches across the platform.</p>
          <Link href="/search" className="text-sm font-medium text-brand hover:underline">
            Open AI search →
          </Link>
        </Card>
        <Card title="Your profile">
          <p className="mb-4 text-sm text-slate-600">Update your title, location, and assigned accounts.</p>
