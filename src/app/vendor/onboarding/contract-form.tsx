  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700">
        <p className="font-medium text-slate-900">Vendor agreement summary</p>
      ...
      <div>
        ...
        <input name="billingEmail" type="email" defaultValue={defaultEmail} required className="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2" />
      </div>
